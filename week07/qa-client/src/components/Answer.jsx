...
function AnswersDisplay(props) {
    ...
    return <Table>
        ...
        <tfoot>
            <tr><td colSpan={5}><AddEditAnswerForm key={editing ? editing.id : -1} mode={mode} editing={editing} addAnswer={props.addAnswer} editAnswer={props.editAnswer} switchToAdd={switchToAdd} /></td></tr>
        </tfoot>
    </Table>
}
...
function AddEditAnswerForm(props) {
